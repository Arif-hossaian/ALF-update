    ...
    <div className="musicPlayer  text-black flex flex-col px-5 w-[100%] border-2 border-red-400 py-3 rounded-xl mt-5">
      ...
      <div className="upperPart flex items-center justify-between">
        ...
        <div className="profile flex">
          <img
            src="https://res.cloudinary.com/arifscloud/image/upload/v1657555293/alf-images/Mask_Group_23_cn4uoh.png"
            alt=""
        ...
        <div>
          <img
            src="https://res.cloudinary.com/arifscloud/image/upload/v1657555291/alf-images/path_cedlhu.png"
            alt=""
            className=" h-[1rem] "
          />
        </div>
