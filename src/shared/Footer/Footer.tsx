...
const Footer: React.FC = () => {
  ...
  return (
    <div className="mt-12">
      <hr />
      <footer className="text-white bg-gradient-to-r from-pink-500 via-green-500 to-yellow-500">
        <div className="max-w-screen-xl px-4 pb-12 mx-auto sm:px-6 lg:px-8">
          <div className="pt-12 mt-32 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
            <nav className="flex justify-center space-x-4 text-sm font-medium sm:justify-start">
              <a className="hover:opacity-75"> {t('appFooterTitle.title1')} </a>
              <a className="hover:opacity-75"> {t('appFooterTitle.policy')} </a>
            </nav>
